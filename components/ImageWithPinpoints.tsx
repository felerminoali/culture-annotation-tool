    ...
    <div className="space-y-2">
      ...
      >
        ...
        {annotations.map((anno) => {
          ...
          const isWarning = anno.isPresent === 'no' || anno.isRelevant === 'no';
          
          // Circles are always red per request. Rects follow status logic.
          const colorClasses = isCircle || isWarning
          ...
          return (
            ...
            >
              <div className={`absolute -top-2 -right-2 w-5 h-5 flex items-center justify-center rounded-full text-white text-[8px] shadow-sm ${
                isCircle || isWarning ? 'bg-red-500' : 'bg-indigo-600'
              }`}>
